  ...
  const services = [
    {
      ...
      description:
        'Simple, high-conversion landing pages built from layouts that worked for our past projects.',
      icon: <Target className="h-6 w-6 text-white" />,
      status: 'In final review',
      highlights: [
        'Clean hero + offer sections',
        'Real-world trust elements',
        'Proven CTA placements for quicker inquiries'
      ]
    },
    {
      title: 'CA Practice Starter Site',
      description:
        'A lightweight website setup made specifically for CA firms who just want clarity, trust, and easy client onboarding.',
      icon: <Book className="h-6 w-6 text-white" />,
      status: 'Partner preview',
      highlights: [
        'Secure document request flow',
        'Service & expertise overview',
        'Professional credibility badges'
      ]
    },
    {
      title: 'Contractor Project Showcase',
      description:
        'A simple portfolio + quote-request combo for builders and contractors who need visibility without complexity.',
      icon: <HardHat className="h-6 w-6 text-white" />,
      status: 'Pilot installs',
      highlights: [
        'Photo gallery for past work',
        'Easy quote request steps',
    ...
    },
    {
      ...
      description:
        'Booking-ready pages for clinics, advisors, and legal professionals who want more scheduled calls without chasing leads.',
      icon: <Briefcase className="h-6 w-6 text-white" />,
      status: 'UX testing live',
      highlights: [
        'Simple consultation scheduler',
        'Service highlight sections',
        'Basic follow-up reminder flow'
      ]
    }
  ];
