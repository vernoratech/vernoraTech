      ...
      <section className="py-24 bg-white text-center border-t border-[#D9E4F2]">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a 
              href="/contact" 
              className="inline-flex items-center justify-center gap-2 rounded-full bg-[#1A3A6F] px-8 py-4 text-base font-bold text-white shadow-xl hover:bg-[#2DA3DB] transition-all hover:-translate-y-1"
            >
              Start Converting
              <Rocket size={20} />
            </a>
