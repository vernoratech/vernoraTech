        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2 text-[#1A3A6F]">
              <li><Link to="/services" className="hover:text-[#1A3A6F] transition duration-300 cursor-pointer">Landing Page Sprints</Link></li>
              <li><Link to="/pricing" className="hover:text-[#1A3A6F] transition duration-300 cursor-pointer">Website Care Plans</Link></li>
              <li><Link to="/process" className="hover:text-[#1A3A6F] transition duration-300 cursor-pointer">Launch Process</Link></li>
              <li><Link to="/technologies" className="hover:text-[#1A3A6F] transition duration-300 cursor-pointer">Technology Stack</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-[#1A3A6F]">
              <li><Link to="/" className="hover:text-[#1A3A6F] transition duration-300">Home</Link></li>
              <li><Link to="/services/footer" className="hover:text-[#1A3A6F] transition duration-300">Services</Link></li>
              <li><Link to="/portfolio" className="hover:text-[#1A3A6F] transition duration-300">Portfolio</Link></li>
              <li><Link to="/blog" className="hover:text-[#1A3A6F] transition duration-300">Insights</Link></li>
              <li><Link to="/contact" className="hover:text-[#1A3A6F] transition duration-300">Contact</Link></li>
            </ul>
          </div>
