              ...
              >
                ...
                <div className="mt-6 md:mt-0 flex-1">
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-2 rounded-full bg-white px-5 py-2.5 text-sm font-bold text-[#1A3A6F] border border-[#D9E4F2] shadow-sm transition-all duration-200 group-hover:bg-[#1A3A6F] group-hover:text-white group-hover:border-[#1A3A6F]"
                  >
                    {phase.cta}
